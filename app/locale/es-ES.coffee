...
#    built_for_teachers_blurb: "Enseñar a los niños a programar puede ser abrumador. CodeCombat ayuda a todos los educadores a enseñar a los estudiantes cómo programar en JavaScript o Python, dos de los lenguajes de programación más populares. Con un plan de estudios comprensible que incluye seis unidades de informática, y refuerza el aprendizaje a través de unidades en el desarrollo de juegos y desarrollo web basados en proyectos, los niños progresarán realizando un viaje ¡desde la sintaxis básica hasta la recursividad!"
#    built_for_teachers_subtitle1: "Informática"
#    built_for_teachers_subblurb1: "Empezando nuestro curso gratuito de Introducción a la Informática, los estudiantes dominarán conceptos básicos de programación como los bucles while / for, las funciones y los algoritmos"
#    built_for_teachers_subtitle2: "Desarrollo de juegos"
#    built_for_teachers_subblurb2: "Los alumnos construyen laberintos y utilizan el manejo de entrada básico para programar sus propios juegos que podrán compartir con sus amigos y familiares"
#    built_for_teachers_subtitle3: "Desarrollo web"
#    built_for_teachers_subblurb3: "Usando HTML, CSS y jQuery, los alumnos ejercitan su musculatura creativa para programar sus propias páginas web con una URL personalizada que podrán compartir con sus compañeros de clase"
    century_skills_title: "Habilidades del siglo 21"
#    century_skills_blurb1: "NO solo el héroe de los estudiantes sube de nivel, ELLOS mismos ascienden"
#    century_skills_quote1: "Te equivocas… y entonces piensas en todas las posibles maneras de arreglarlo, y luego lo intentas de nuevo. No podría llegar hasta aquí sin esforzarme"
#    century_skills_subtitle1: "Pensamiento crítico"
#    century_skills_subblurb1: "Con los rompecabezas de programación que se organizan naturalmente en niveles cada vez más desafiantes, el juego de programación de CodeCombat garantiza que los niños practiquen continuamente el pensamiento crítico"
#    century_skills_quote2: "Todos los demás estaban haciendo laberintos, así que pensé, ‘captura la bandera’ y eso es lo que hice"
#    century_skills_subtitle2: "Creatividad"
#    century_skills_subblurb2: "CodeCombat anima a los estudiantes a mostrar su creatividad construyendo sus propios juegos y páginas web y compartiéndolos"
#    century_skills_quote3: "Si me atasco en un nivel. Trabajo con la gente que me rodea hasta que podamos resolverlo juntos"
#    century_skills_subtitle3: "Colaboración"
#    century_skills_subblurb3: "A los largo del juego, hay oportunidades para que los estudiantes colaboren cuando se atascan y trabajen juntos usando nuestra guía de programación en pareja"
#    century_skills_quote4: "Siempre he tenido la aspiración de diseñar videojuegos y aprender a programar... y esto me da un estupendo punto de partida"
#    century_skills_subtitle4: "Comunicación"
#    century_skills_subblurb4: "La programación requiere que los niños practiquen nuevas formas de comunicación, incluida la comunicación con la computadora y la transmisión de sus ideas a través del código más eficiente"
#    classroom_in_box_title: "Nos esforzamos por:"
#    classroom_in_box_blurb1: "Involucrar a todos los estudiantes para que confíen en que la programación en para ellos"
#    classroom_in_box_blurb2: "Darle el poder a cualquier educador para que se sienta seguro enseñando a programar"
#    classroom_in_box_blurb3: "Inspirar a todos los líderes escolares a que creen un programa de informática de clase mundial"
#    classroom_in_box_blurb4: ""
#    covid19_banner_blurb: "Ofrecemos acceso gratuito a nuestro plan de estudios completo para educadores y escuelas afectadas por el cierre de colegios"
#    click_here: "Haz click aquí"
#    creativity_rigor_title: "Donde la creatividad alcanza el rigor"
#    creativity_rigor_subtitle1: "Haz que la programación sea divertida y enseña habilidades del mundo real"
#    creativity_rigor_blurb1: "Los estudiantes escriben Python y JavaScript real mientras juegan a juegos que promueven el ensayo-error, el pensamiento crítico y la creatividad. Luego, los estudiantes aplican las habilidades de programación aprendidas a haber desarrollado sus propios juegos y páginas web en cursos basados en proyectos"
#    creativity_rigor_subtitle2: "Haz llegar a los estudiantes a sus niveles"
#    creativity_rigor_blurb2: "Cada nivel de CodeCombat está basado en millones de datos y optimizado para adaptarse a cada alumno. Los niveles de prácticas y las pistas ayudan a los estudiantes cuando se atascan y los niveles con desafíos evalúan el aprendizaje de los estudiantes durante el juego"
#    creativity_rigor_subtitle3: "Creado para todos los profesores, independientemente de su experiencia"
#    creativity_rigor_blurb3: "El plan de estudios de CodeCombat, a su propio ritmo y alineado con los estándares hace posible la enseñanza de la informática para cualquier persona. CodeCombat equipa a los profesores con el entrenamiento, los recursos de instrucción y un dedicado apoyo para que se sientan seguros y exitosos en el aula"
...
#    for_leaders_blurb: "Un exhaustivo programa de informática alineado con los estándares"
#    for_leaders_subtitle1: "Fácil de implementar"
#    for_leaders_subblurb1: "Un programa basado en la web que no necesita apoyo de IT. Empieza en menos de 5 minutos usando Google o el Inicio de Sesión único inteligente (SSO)"
#    for_leaders_subtitle2: "Completo plan de estudios de programación"
#    for_leaders_subblurb2: "Un plan de estudios alineado con los estándares con recursos de instrucción y desarrollo profesional para habilitar a cualquier profesor a enseñar informática"
#    for_leaders_subtitle3: "Casos de uso flexibles"
#    for_leaders_subblurb3: "Tanto si quieres crear una asignatura optativa de programación en secundaria, una vía CTE, como si estás enseñando una clase de introducción a la informática, CodeCombat se adapta a tus necesidades"
#    for_leaders_subtitle4: "Habilidades del mundo real"
#    for_leaders_subblurb4: "A través de los desafíos de programación, los estudiantes desarrollan agallas y una mentalidad de crecimiento, que los preparan para las más de 500 mil ofertas laborales relacionadas con la informática"
#    for_teachers_title: "Para profesores"
#    for_teachers_blurb: "Herramientas para liberar el potencial de los estudiantes"
#    for_teachers_subtitle1: "Aprendizaje basado en proyectos"
#    for_teachers_subblurb1: "Promueve la creatividad, la resolución de problemas y la confianza, a través de cursos basados en proyectos en los que los estudiantes desarrollan sus propios juegos y páginas web"
#    for_teachers_subtitle2: "Panel del profesor"
#    for_teachers_subblurb2: "Ver los datos de progreso de los estudiantes, descubrir los recursos del plan de estudios y acceder a soporte en tiempo real para potenciar el aprendizaje de los estudiantes"
#    for_teachers_subtitle3: "Evaluaciones incorporadas"
#    for_teachers_subblurb3: "Personalizar la instrucción y asegurarse de que los estudiantes entiendan los conceptos básicos con evaluaciones formativas y acumulativas"
#    for_teachers_subtitle4: "Diferenciación automática"
#    for_teachers_subblurb4: "Involucrar a todos los alumnos en un aula diversa, con niveles de práctica que se adapten a las necesidades de aprendizaje de cada alumno"
#    game_based_blurb: "CodeCombat es un programa informático basado en juegos, en el que los estudiantes escriben código real y ven a sus personajes reaccionar en tiempo real"
...
#    quotes_quote1: "Nombra cualquier programa en línea, ya lo he probado. Y ninguno de ellos se equipara a CodeCombat. Cualquier profesor que quiera que sus alumnos aprendan a programar... ¡que empiece aquí!"
#    quotes_quote2: "Me sorprendió lo fácil e intuitivo que CodeCombat hace el aprendizaje de la informática. Las calificaciones en el examen de AP fueron mucho más altas de lo que esperaba y creo que CodeCombat es la razón"
#    quotes_quote3: "CodeCombat ha sido el método más beneficioso para enseñar a mis estudiantes las capacidades de programación de la vida real. Mi marido es ingeniero de software y ha probado todos mis programas. Y valoró este como el mejor"
#    quotes_quote4: "Los comentarios... han sido tan positivos que estamos estructurando una clase de informática en torno a CodeCombat. El programa realmente involucra a los estudiantes con una plataforma de estilo de juego entretenida e instructiva al mismo tiempo. ¡Sigan con el buen trabajo, CodeCombat!"
#    see_example: "Ver un ejemplo"
    slogan: "El juego más atractivo para aprender a programar." # {change}
#    teach_cs1_free: "Enseña programación gratis"
#    teachers_love_codecombat_title: "A los profesores les encanta CodeCombat"
#    teachers_love_codecombat_blurb1: "Informan que sus alumnos disfrutan usando CodeCombat para aprender a programar"
#    teachers_love_codecombat_blurb2: "Recomendarían CodeCombat a otros profesores de informática"
#    teachers_love_codecombat_blurb3: "Dicen que CodeCombat les ayuda a apoyar las habilidades de resolución de problemas de los estudiantes"
...
#    top_banner_blurb: "Padres, reservad la primera clase de programación en línea en vivo para vuestro hijo ¡gratis!"
...
#    im_an_educator: "Soy educador"
    im_a_teacher: "Soy profesor"
    im_a_student: "Soy alumno"
    learn_more: "Aprende más"
    classroom_in_a_box: "Una clase todo en uno para enseñar informática"
    codecombat_is: "CodeCombat es una plataforma <strong> para que los estudiantes </strong> aprendan informática mientras juegan a un juego real"
    ...
    teaching_computer_science: "Enseñar informática no requiere de un título caro, porque nosotros proveemos las herramientas para apoyar a educadores con cualquier nivel de conocimientos"
    accessible_to: "Accesible para"
    everyone: "todo el mundo"
    democratizing: "La democratización del proceso de aprendizaje es el núcleo de nuestra filosofía. Todo el mundo debe ser capaz de aprender a programar"
    forgot_learning: "En realidad creo que olvidaron que en realidad están aprendiendo algo" # {change}
    wanted_to_do: "Programar es algo que siempre he querido hacer, pero nunca pensé que sería capaz de aprenderlo en la escuela"
#    builds_concepts_up: "Me gusta cómo CodeCombat construye los conceptos. Es muy fácil de entender y divertido de resolver"
    why_games: "¿Por qué es importante aprender usando juegos?"
    games_reward: "Los juegos premian el esfuerzo productivo"
    encourage: "Jugar es un excelente medio que promueve la interacción, el descubrimiento y el aprendizaje a través del ensayo-error. Un buen juego reta al jugador a dominar habilidades con el paso del tiempo, que es el mismo proceso crítico por el que pasan los estudiantes al aprender"
    excel: "Los juegos son excelentes premiando"
    struggle: "el esfuerzo productivo"
    kind_of_struggle: "el tipo de esfuerzo que resulta en aprendizaje que es atractivo y"
    motivating: "motivante"
    not_tedious: "no tedioso"
    gaming_is_good: "Estudios sugieren que jugar es bueno para el cerebro de los niños. (¡Es verdad!)"
    game_based: "Cuando los sistemas de aprendizaje basados en juegos son"
    compared: "comparados"
    conventional: "contra los métodos convencionales de evaluación, la diferencia es clara: los juegos son mejores ayudando a los alumnos a retener conocimiento, a concentrarse y"
    perform_at_higher_level: "a desempeñarse a un nivel superior"
    feedback: "Los juegos también proporcionan retroalimentación en tiempo real, que permite a los estudiantes ajustar su camino hacia la solución y entender los conceptos de manera más holística, en lugar de limitarse a respuestas 'correctas' o 'incorrectas'"
    ...
    request_demo_subtitle: "Solicita una demostración y empieza a jugar con tus estudiantes en menos de una hora"
    get_started_title: "Configura hoy tu clase"
    get_started_subtitle: "Prepara tu clase, añade cuentas de estudiantes y sigue su progreso a medida que aprenden a programar"
    request_demo: "Pide una demostración"
#    request_quote: "Solicita presupuesto"
    setup_a_class: "Configura una clase"
    ...
    winning: "Una combinación ganadora entre un juego de rol y una tarea de programación que hacen la educación amigable y divertida para los niños"
    ...
    educator: "Educador"
    student: "Estudiante"
#    our_coding_programs: "Nuestros programas de programación"
#    codecombat: "CodeCombat"
#    ozaria: "Ozaria"
#    codecombat_blurb: "Nuestro juego de programación original. Recomendado para padres, individuos, educadores y estudiantes que quieran experimentar uno de los juegos de programación más queridos del mundo"
#    ozaria_blurb: "Un juego de aventuras y un programa de informática en el que los estudiantes dominan la magia perdida de la programación para salvar su mundo. Recomendado para educadores y estudiantes"
...
#    try_ozaria: "Prueba Ozaria"
  ...
  nav:
    ...
    help_pref: "¿Necesitas ayuda? ¡Envíamos un correo electrónico"
    help_suff: "y pronto nos pondremos en contacto contigo!"
...
#    browser_recommendation: "For the best experience we recommend using the latest version of Chrome. Download the browser here!"
  ...
  diplomat_suggestion:
    ...
    pitch_body: "Nosotros desarrollamos CodeCombat en inglés, pero ya tenemos jugadores en todo el mundo. Muchos de ellos quieren jugar en español porque no hablan inglés, así que si hablas ambos idiomas, inscríbete como Diplomático y ayuda a traducir la web y todos los niveles de CodeCombat al español"
  ...
  play:
#    title: "Juega a los niveles de CodeCombat: aprende Python, JavaScript y HTML"
#    meta_description: "Aprende a programar con un juego de programación para principiantes. Aprende Python o JavaScript mientras resuelves laberintos, creas tus propios juegos y subes de nivel. ¡Desafía a tus amigos en los niveles de arena multijugador!"
#    level_title: "__nivel__ - Aprende a programar en Python, JavaScript, HTML"
#    video_title: "__vídeo__ | Vídeo de Nivel"
#    game_development_title: "__nivel__ | Desarollo de Juegos"
#    web_development_title: "__nivel__ | Desarrollo de Páginas Web"
#    anon_signup_title_1: "CodeCombat tiene una"
#    anon_signup_title_2: "Versión de aula!"
#    anon_signup_enter_code: "Introduce el código de la clase:"
#    anon_signup_ask_teacher: "¿No tienes uno? ¡Pregúntale a tu profesor!"
#    anon_signup_create_class: "¿Quieres crear una clase?"
#    anon_signup_setup_class: "Configura una clase, añade a tus alumnos ¡y supervisa su progreso!"
#    anon_signup_create_teacher: "Crea una cuenta gratuita de profesor"
    play_as: "Jugar como" # Ladder page
    get_course_for_class: "¡Asigna desarrollo de juegos y más a tus clases!"
#    request_licenses: "Contacta con nuestros especialistas escolares para saber más"
    compete: "¡Compite!" # Course details page
    spectate: "Observa" # Ladder page
#    simulate_all: "Simular todo"
    ...
    next: "Siguiente héroe" # Go from choose hero to choose inventory before playing a level
    change_hero: "Seleccionar héroe" # Go back from choose inventory to choose hero
    ...
    subscriber_heroes: "¡Suscríbete hoy para desbloquear inmediatamente a Amara, Hushbaum y Hattori!"
    ...
    brain_pop_challenge: "Desafíate a jugar otra vez usando un lenguaje de programación diferente!"
    replay: "Repetir"
  ...
  share_progress_modal:
    blurb: "¡Estás progresando bastante bien! Cuéntales a tus padres cuánto has aprendido con CodeCombat"
    email_invalid: "La dirección de correo electrónico no es válida"
    form_blurb: "¡Introduce tu correo electrónico y os mostraremos!"
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    email_announcements: "¡Recibe anuncios sobre los nuevos niveles y características de CodeCombat!"
...
#    teacher_email_announcements: "Keep me updated on new teacher resources, curriculum, and courses!"
    ...
    required: "Tienes que estar registrado antes de continuar"
    login_switch: "¿Ya tienes una cuenta?"
    optional: "opcional"
    connected_gplus_header: "¡Te has conectado con éxito con Google+!"
    connected_gplus_p: "Termina el registro para poder iniciar sesión con tu cuenta de Google+"
    connected_facebook_header: "¡Te has conectado correctamente con Facebook!"
    connected_facebook_p: "Termina el registro para poder iniciar sesión con tu cuenta de Facebook"
    hey_students: "Alumnos, introducid el código de clase de vuestro maestro"
    birthday: "Cumpleaños"
#    parent_email_blurb: "Sabemos que no puedes esperar para aprender a programar &mdash; ¡nosotros también estamos emocionados! Tus padres recibirán un correo electrónico con más instrucciones sobre cómo crear una cuenta para ti. Envía un correo electrónico a {{email_link}} si tienes alguna pregunta"
#    classroom_not_found: "No figura ninguna clase con este código. Revisa tu ortografía o pide ayuda a tu maestro"
#    checking: "Comprobando..."
    account_exists: "Este correo electrónico ya está en uso:"
    sign_in: "Iniciar Sesión"
    email_good: "¡El correo electrónico parece bueno!"
#    name_taken: "¡Ese nombre de usuario ya está en uso! ¿Lo intentas con {{suggestedName}}?"
    ...
    teacher_type_1: "Enseña programación utilizando CodeCombat!"
    teacher_type_2: "Configura tu clase"
    teacher_type_3: "Accede a las guías del curso"
    teacher_type_4: "Ve el progreso del estudiante"
    signup_as_teacher: "Iniciar sesión como profesor"
    student_type_1: "¡Aprende a programar mientras juegas a un atractivo juego!"
    student_type_2: "Juega con tu clase"
#    student_type_3: "Compite en la arena"
#    student_type_4: "¡Escoge a tu héroe!"
#    student_type_5: "¡Ten tu código de clase a mano!"
    signup_as_student: "Iniciar sesión como Estudiante"
#    individuals_or_parents: "Individuos y Padres"
#    individual_type: "Para los jugadores que aprenden a programar fuera de una clase. Los padres deben registrarse para tener una cuenta aquí"
#    signup_as_individual: "Regístrate como individuo"
#    enter_class_code: "Introduce tu código de clase"
#    enter_birthdate: "Introduce tu fecha de nacimiento:"
#    parent_use_birthdate: "Padres, utilizad vuestra propia fecha de nacimiento"
#    ask_teacher_1: "Pídele a tu profesor tu código de clase"
#    ask_teacher_2: "¿No eres parte de una clase? Crear una"
#    ask_teacher_3: "Cuenta individual"
#    ask_teacher_4: "en su lugar"
#    about_to_join: "Vas a unirte a:"
#    enter_parent_email: "Introduce el correo electrónico de tus padres:"
#    parent_email_error: "Ha ocurrido un error al intentar enviar el correo electrónico. Comprueba la dirección de correo y vuelve a intentarlo"
#    parent_email_sent: "Hemos enviado un correo electrónico con más instrucciones sobre cómo crear una cuenta. Pídele a tus padres que revisen su bandeja de entrada"
#    account_created: "¡Cuenta creada!"
#    confirm_student_blurb: "Anota tu información para no olvidarla. Tu profesor también puede ayudarte a restablecer tu contraseña en cualquier momento"
#    confirm_individual_blurb: "Anota tu información de inicio de sesión por si la necesitas más adelante. Comprueba tu correo electrónico para poder recuperar tu cuenta si alguna vez olvidas tu contraseña - ¡revisa la bandeja de entrada!"
#    write_this_down: "Escribe esto:"
#    start_playing: "Empieza a jugar!"
#    sso_connected: "Conectado exitosamente con:"
#    select_your_starting_hero: "Selecciona a tu héroe inicial:"
#    you_can_always_change_your_hero_later: "Podrás cambiar tu héroe más adelante"
#    finish: "Finalizar"
#    teacher_ready_to_create_class: "¡Ya estás listo para crear tu primera clase!"
#    teacher_students_can_start_now: "Tus alumnos podrán empezar a jugar el primer curso, Introducción a la informática, de forma inmediata"
#    teacher_list_create_class: "En la siguiente pantalla podrás crear una nueva clase"
#    teacher_list_add_students: "Añade estudiantes a la clase haciendo click en el enlace "Ver clase" y luego envía a tus estudiantes el código de clase o la URL. También puedes invitarlos por correo electrónico si tienen direcciones de correo"
#    teacher_list_resource_hub_1: "Revisar las"
#    teacher_list_resource_hub_2: "Guías de Curso"
#    teacher_list_resource_hub_3: "para soluciones a todos los niveles, y el"
#    teacher_list_resource_hub_4: "Centro de Recursos"
#    teacher_list_resource_hub_5: "para guías curriculares, actividades ¡y más!"
#    teacher_additional_questions: "¡Eso es todo! Si necesitas más ayuda o tienes preguntas, contacta con __supportEmail__"
#    dont_use_our_email_silly: "¡No pongas nuestro correo electrónico aquí! Pon el de tus padres"
#    want_codecombat_in_school: "¿Quieres jugar a CodeCombat todo el tiempo?"
#    eu_confirmation: "Acepto permitir que CodeCombat almacene mis datos en servidores de EE. UU"
#    eu_confirmation_place_of_processing: "Obtén más información sobre los posibles riesgos"
#    eu_confirmation_student: "Si no estás seguro, pregúntale a tu profesor"
#    eu_confirmation_individual: "Si no quieres que almacenemos tus datos en servidores de EE. UU., Siempre puedes seguir jugando de forma anónima sin guardar tu código"
#    password_requirements: "de 8 a 64 caracteres sin repetición"
#    invalid: "No válido"
#    invalid_password: "Contraseña no válida"
#    with: "con"
#    want_to_play_codecombat: "No, no tengo, ¡pero quiero jugar a CodeCombat!"
#    have_a_classcode: "¿Tienes un código de clase?"
#    yes_i_have_classcode: "¡Sí, tengo un código de clase!"
#    enter_it_here: "Escríbelo aquí:"
...
#    concept_challenge_goal: "Meta del Desafío de concepto"
...
#    restart_really: "¿Estás seguro de querer reiniciar el nivel? Perderás todo el código que escribiste"
    ...
    victory_saving_progress: "Guardando el Progreso"
    ...
    victory_viking_code_school: "¡Jolines, el nivel que acabas de pasar era difícil! Si aún no eres un desarrollador de software, deberías serlo. Acabas de conseguir una aceptación por vía rápida con la Escuela Vikinga de Có, donde puedes llevar tus habilidades al siguiente nivel y convertirte en un desarrollador web profesional en 14 semanas"
...
#    loading_start_concept: "Iniciar Desafío de concepto"
    ...
    infinite_loop_description: "El código inicial para construir el mundo no acabó de ejecutarse. Probablemente es muy lento o tiene un loop infinito. O puede ser un bug. Puedes intentar ejecutar este código nuevamente o reiniciar el código a su estado por defecto. Si eso no lo arregla, dínoslo"
    check_dev_console: "También puedes abrir la consola de desarrollo para ver qué puede salir mal"
    ...
    tip_scrub_shortcut: "Usa Ctrl+[ y Ctrl+] para rebobinar y avanzar rápido"
    tip_guide_exists: "Haz click en la guía de la parte superior de la página para obtener más información útil"
    ...
    tip_forums: "¡Visita los foros y dinos lo que piensas!"
    tip_baby_coders: "En el futuro, incluso los bebés serás Archimagos"
    tip_morale_improves: "La carga seguirá hasta que mejore la moral"
